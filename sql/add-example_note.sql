--
-- Tables for the FennecAdvancedSearch extension
--

-- Notes table
CREATE TABLE /*_*/fennecadvancedsearch_note (
...
CREATE INDEX /*i*/exnote_user_page ON /*_*/fennecadvancedsearch_note (exnote_user, exnote_page);

-- For querying of all notes from all users on a certain page
--  (e.g. "Notes by other users" on a certain page).
CREATE INDEX /*i*/exnote_page_user ON /*_*/fennecadvancedsearch_note (exnote_page, exnote_user);
